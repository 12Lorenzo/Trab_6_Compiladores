...
public class DragonCardsLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"Poder", "ESC_SEQ", "COMENTARIO", "WS", "ERRO"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'dragao chefe'", "'fim chefe'", "'Lutar'", "'Desistir'", null, "','", 
			"':'", "'('", "')'"
		};
	}
	...
	public DragonCardsLexer(CharStream input) {
		super(input);
