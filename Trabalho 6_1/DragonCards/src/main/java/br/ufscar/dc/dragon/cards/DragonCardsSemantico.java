...
public class DragonCardsSemantico extends dragonCardsBaseVisitor<Void>{
    ...
    public Void visitDeclaracao_equipe(dragonCardsParser.Declaracao_equipeContext ctx){
        ...
        if (ctx.Nome() != null) {
            ...
            if (tamEquipe>3) {
                ...
                switch (tipo) {
                    case CLASSICO:
                        tipoDiv = "<img src = \'https://img.freepik.com/vetores-gratis/ilustracao-de-silhueta-de-dragao-de-design-plano_23-2149455624.jpg?w=826&t=st=1693687866~exp=1693688466~hmac=fcc6d40e4b60279115f94ad9f2f2ead3894d8c9403b7c8aa51382bfd2dddb435'width=\"25\" height=\"25\">\n";
                        break;

                    case ORIENTAL:
                        tipoDiv = "<img src = \'https://img.freepik.com/vetores-gratis/ano-do-simbolo-do-zodiaco-do-vetor-preto-e-branco-do-dragao-isolado-em-um-fundo-branco_8130-2589.jpg?w=900&t=st=1693688259~exp=1693688859~hmac=5f0dccc6cda8b9c278672318d515622160136ffcee36f58bb282a2a24cbb790a'width=\"25\" height=\"25\">\n";
                        break;

                    case WYVERN:
                        tipoDiv = "<img src = \'https://as2.ftcdn.net/v2/jpg/04/43/64/91/1000_F_443649119_7UriZ4ZI5aIGuxNvP8NT8GgeQC2aq0Lp.jpg'width=\"25\" height=\"25\">\n";
                        break;

                    case DRAKE:
                        tipoDiv = "<img src = \'https://i.pinimg.com/736x/e3/e2/14/e3e214979a131c440b0a2dd32c230602.jpg'width=\"25\" height=\"25\">\n";
                        break;

                    case LINDWRUM:
                        tipoDiv = "<img src = \'https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/f5f236c1-684d-4e21-a29f-03922867cb38/d5i0wj4-61a1b842-80c2-4b66-9b7b-26532281b206.png?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..c9v5PLKbGwRgORqErH03mZ64y5TdBdV07QPNZ8v7od4'width=\"25\" height=\"25\">\n";
                        break;

                    case AMPHIPTERE:
                        tipoDiv = "<img src = \'https://upload.wikimedia.org/wikipedia/commons/7/7b/Amphiptere.jpg'width=\"25\" height=\"25\">\n";
                        break;
                ...
                if(tamEquipe == 1){
                    String div = "                <td><div id=\"box\">\n"
                            ...
                            + "                    <font color=\"#ffffff\">HP</font> "  + poder + "<p><p><p>\n";
    ...
    public Void visitCmdProxima(dragonCardsParser.CmdProximaContext ctx) {
        ...
        if(tabela.existe(nome)){
            ...
            GeradorHTML.AddComando(acao);
            GeradorHTML.AdicionaString("                    <div id=\"erros\">" + 
                "O pokemon " + nome + " não esta na equipe!</div>\n");
        }
